...
#
# install.sh - Installation script of dotfiles
#
# Usage:
...
show_help() {
    ...
    printf "    ./install.sh --profile=minimal        # Installation minimale\n"
    printf "    ./install.sh --backup --profile=full  # Backup puis installation full\n"
    printf "    ./install.sh --dry-run                # Prévisualisation\n\n"
}
